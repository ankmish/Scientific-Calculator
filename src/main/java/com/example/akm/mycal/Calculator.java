    ...
    private void handleEquals(int newOperator) {
        if (hasChanged) {
            switch (operator) {
                ...
                case 7:
                    num = num
                            + Math.sin(Double.parseDouble(txtCalc.getText().toString()));
                    break;
                case 8:
                    num = num
                            + Math.cos(Double.parseDouble(txtCalc.getText().toString()));
                    break;
                case 9:
                    num = num
                            + Math.tan(Double.parseDouble(txtCalc.getText().toString()));
                    break;
                case 10:
                    num = Math.log(Double.parseDouble(txtCalc.getText().toString()));
                    break;
                case 11:
                    double loge = Math.log(Double.parseDouble(txtCalc.getText().toString()));
                    num = Math.exp(loge);
                    break;
                case 12:
                    num = Math.PI;
